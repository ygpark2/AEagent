...
config :aos,
  ...
  max_refinement_attempts: integer_env.("MAX_REFINEMENT_ATTEMPTS", 3),
  dag_engine_enabled: boolean_env.("DAG_ENGINE_ENABLED", false),
  harness_enabled: boolean_env.("HARNESS_ENABLED", true),
  harness_manifest_path: System.get_env("HARNESS_MANIFEST_PATH") || "harness/manifest.json",
  harness_verification_timeout_ms: integer_env.("HARNESS_VERIFICATION_TIMEOUT_MS", 120_000),
  harness_entropy_audit_enabled: boolean_env.("HARNESS_ENTROPY_AUDIT_ENABLED", true),
